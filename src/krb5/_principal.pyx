...
def build_principal(
    ...
    if component_count == 2 and component_list[0] == b'krbtgt':
        inferred_principal_type = 2  # KRB5_NT_SRV_INST
    elif component_count >= 2 and component_list[0] == b'WELLKNOWN':
        inferred_principal_type = 11  # KRB5_NT_WELLKNOWN
    else:
        inferred_principal_type = 1  # KRB5_NT_PRINCIPAL
